# Ejemplos de reCaptcha con Python - CapSolver

Esta carpeta contiene ejemplos de implementación en Python para resolver diferentes tipos de reCaptcha usando CapSolver.
...
**Archivo:** `recaptcha_v2_normal.py`
...
**Archivo:** `recaptcha_v2_pageaction.py`
...
**Archivo:** `recaptcha_v2_enterprise_invisible_session.py`
...
**Archivo:** `recaptcha_v3_normal.py`
