...
Resuelve desafíos de reCaptcha V2 con parámetros de site key, page URL y pageAction
"""
...
def resolver_recaptcha_v2(site_key, page_url, page_action):
    """
    ...
    Args:
        ...
        page_action (str): El parámetro pageAction
...
def main():
    ...
    print("Ejemplo con pageAction")
    print("=" * 60)
    
    try:
        # Paso 1: Resolver el reCaptcha
        token = resolver_recaptcha_v2(SITE_KEY, PAGE_URL, PAGE_ACTION)
